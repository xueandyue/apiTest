# Generated by Django 2.0.3 on 2019-12-09 11:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tester', models.CharField(max_length=20, verbose_name='测试')),
                ('dev', models.CharField(max_length=20, verbose_name='开发')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('belong_module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Index.ModuleInfo')),
            ],
            options={
                'verbose_name': '用例信息',
        ...
        migrations.AddField(
            ...
            name='belong_project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Index.ProjectInfo'),
        ),
    ]
